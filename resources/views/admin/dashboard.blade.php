...
<div class="dash">
    ...
    <div class="charts-grid">
        ...
        <x-admin-mini-chart
            id="chart-orders"
            title="Total Orders"
            :labels="$orderMonthly['labels']"
            :values="$orderMonthly['values']"
            :max="$orderMonthly['max']"
            color="#1b7a62"
        />
        <x-admin-mini-chart
            id="chart-customers"
            title="Customers"
            :labels="$customerMonthly['labels']"
            :values="$customerMonthly['values']"
            :max="$customerMonthly['max']"
            color="#b45309"
        />
    </div>
